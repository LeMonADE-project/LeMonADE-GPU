...
class UpdaterGPUScBFM_AA_Breaking: public UpdaterGPUScBFM_AA_Connection<T_UCoordinateCuda>
{

public:
    typedef UpdaterGPUScBFM_AA_Connection< T_UCoordinateCuda> BaseClass;
    using T_Flags            = UpdaterGPUScBFM_AA_Connection<  uint8_t > :: T_Flags      ;
    using T_Lattice          = UpdaterGPUScBFM_AA_Connection< uint8_t >::T_Lattice    ;
    using T_Coordinate       = UpdaterGPUScBFM_AA_Connection< uint8_t >::T_Coordinate ;
    using T_Coordinates      = UpdaterGPUScBFM_AA_Connection< uint8_t >::T_Coordinates;
    using T_Id               = UpdaterGPUScBFM_AA_Connection< uint8_t >::T_Id         ;
